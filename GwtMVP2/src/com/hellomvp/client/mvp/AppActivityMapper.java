...
import com.hellomvp.client.activity.SameRandomNumberActivity;
...
public class AppActivityMapper implements ActivityMapper {
  ...
  public Activity getActivity(Place place) {
    ...
    else if (place instanceof SameRandomNumberPlace)
    {
      return new SameRandomNumberActivity((SameRandomNumberPlace)place, clientFactory);
    }
    return null;
  }
}
